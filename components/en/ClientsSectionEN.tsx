...
const clients = [
  { name: "Ricehouse", logo: "/logos/ricehouse_white.webp", scale: 0.95, invert: false, href: "/en/case-studies/ricehouse" },
  ...
  { name: "Findomestic", logo: "/logos/findomestic_white.webp", scale: 1.15, invert: false, href: "/en/case-studies/findomestic" },
  ...
  { name: "Comune di Vercelli", logo: "/logos/comune_vercelli_white.png", scale: 1.05, invert: false, href: "/en/case-studies/comune-di-vercelli-gender-violence" },
];

// Duplicate the array 3 times for seamless infinite scroll
const duplicatedClients = [...clients, ...clients, ...clients];

const ClientsSectionEN = () => {
  return (
        ...
        <div className="flex items-center animate-scroll hover:[animation-play-state:paused]">
          {duplicatedClients.map((client, index) => (
            <Link
              ...
              aria-label={`Open ${client.name} case study`}
...
export default ClientsSectionEN;
